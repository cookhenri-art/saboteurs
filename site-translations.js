...
const SITE_TRANSLATIONS = {
  ...
  stats: {
    ...
    power_champion_desc: { fr: "Moyenne pondérée globale", en: "Overall weighted average", es: "Promedio ponderado global", de: "Gesamtgewichteter Durchschnitt", it: "Media ponderata globale", pt: "Média ponderada geral", nl: "Totaal gewogen gemiddelde" },
    ...
    power_resistant_desc: { fr: "Temps vivant / temps total", en: "Time alive / total time", es: "Tiempo vivo / tiempo total", de: "Überlebenszeit / Gesamtzeit", it: "Tempo vivo / tempo totale", pt: "Tempo vivo / tempo total", nl: "Tijd levend / totale tijd" },
    ...
    first_game_played: { fr: "Dès ta 1ère partie jouée", en: "After your 1st game played", es: "Desde tu 1ª partida jugada", de: "Nach deinem 1. gespielten Spiel", it: "Dalla tua 1ª partita giocata", pt: "Após sua 1ª partida jogada", nl: "Na je 1e gespeelde spel" },
    top_25_verified: { fr: "Top 25% des joueurs vérifiés", en: "Top 25% of verified players", es: "Top 25% de jugadores verificados", de: "Top 25% der verifizierten Spieler", it: "Top 25% dei giocatori verificati", pt: "Top 25% dos jogadores verificados", nl: "Top 25% van geverifieerde spelers" },
    top_10_verified: { fr: "Top 10% des joueurs vérifiés", en: "Top 10% of verified players", es: "Top 10% de jugadores verificados", de: "Top 10% der verifizierten Spieler", it: "Top 10% dei giocatori verificati", pt: "Top 10% dos jogadores verificados", nl: "Top 10% van geverifieerde spelers" },
    top_5_verified: { fr: "Top 5% des joueurs vérifiés", en: "Top 5% of verified players", es: "Top 5% de jugadores verificados", de: "Top 5% der verifizierten Spieler", it: "Top 5% dei giocatori verificati", pt: "Top 5% dos jogadores verificados", nl: "Top 5% van geverifieerde spelers" },
    top_3_verified: { fr: "Top 3% des joueurs vérifiés", en: "Top 3% of verified players", es: "Top 3% de jugadores verificados", de: "Top 3% der verifizierten Spieler", it: "Top 3% dei giocatori verificati", pt: "Top 3% dos jogadores verificados", nl: "Top 3% van geverifieerde spelers" },
    ...
    champion_calc: { fr: "Moyenne pondérée de tous les pouvoirs (sauf Exterminateur)", en: "Weighted average of all powers (except Exterminator)", es: "Promedio ponderado de todos los poderes (excepto Exterminador)", de: "Gewichteter Durchschnitt aller Kräfte (außer Ausrotter)", it: "Media ponderata di tutti i poteri (tranne Sterminatore)", pt: "Média ponderada de todos os poderes (exceto Exterminador)", nl: "Gewogen gemiddelde van alle krachten (behalve Verdelger)" },
    ...
    exterminator_calc: { fr: "Potions mortelles utilisées sur astronautes (non comptabilisé dans Champion)", en: "Death potions used on astronauts (not counted in Champion)", es: "Pociones mortales usadas en astronautas (no contabilizado en Campeón)", de: "Todesränke auf Astronauten verwendet (nicht in Champion gezählt)", it: "Pozioni mortali usate su astronauti (non conteggiato in Campione)", pt: "Poções mortais usadas em astronautas (não contabilizado em Campeão)", nl: "Doodsdrankjes gebruikt op astronauten (niet geteld in Kampioen)" },
