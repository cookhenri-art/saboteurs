...
const SITE_TRANSLATIONS = {
  ...
  stats: {
    ...
    power_doctor_desc_suffix: { fr: "potions mort", en: "death potions", es: "pociones de muerte", de: "Todesränke", it: "pozioni morte", pt: "poções morte", nl: "doodsdrankjes" },
    power_bluffer_desc_prefix: { fr: "Victoire", en: "Win", es: "Victoria", de: "Sieg", it: "Vittoria", pt: "Vitória", nl: "Overwinning" },
    power_bluffer_desc_suffix: { fr: "vote contre toi", en: "vote against you", es: "voto en tu contra", de: "Stimme gegen dich", it: "voto contro di te", pt: "voto contra você", nl: "stem tegen je" },
    power_exterminator_desc_prefix: { fr: "Potions mort sur", en: "Death potions on", es: "Pociones de muerte en", de: "Todesränke auf", it: "Pozioni morte su", pt: "Poções morte em", nl: "Doodsdrankjes op" },
    power_investigator_desc_prefix: { fr: "Votes justes vs", en: "Correct votes vs", es: "Votos correctos vs", de: "Richtige Stimmen vs", it: "Voti corretti vs", pt: "Votos corretos vs", nl: "Correcte stemmen vs" },
    power_captain_desc_prefix: { fr: "Départages + transferts pro-", en: "Tiebreaks + pro-", es: "Desempates + transferencias pro-", de: "Stichentscheide + Pro-", it: "Spareggi + trasferimenti pro-", pt: "Desempates + transferências pro-", nl: "Stemmingen + pro-" },
    power_security_desc_prefix: { fr: "Vengeance efficace vs", en: "Effective revenge vs", es: "Venganza efectiva vs", de: "Effektive Rache vs", it: "Vendetta efficace vs", pt: "Vingança eficaz vs", nl: "Effectieve wraak vs" },
